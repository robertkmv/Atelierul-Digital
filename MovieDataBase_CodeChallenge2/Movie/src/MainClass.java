public class MainClass {
    public static void main(String[] args) {
        ...
        //1.
        System.out.println("Studio-urile care produc cel putin 2 filme");
        ...
        //2.
        System.out.println("Actori cu 2 oscaruri joaca in filme produse in urmatoarele studio-uri: ");
        for (int i = 0; i < studioDataBase.length; i++) {
        ...
        //3.
        System.out.println("Filme in care joaca cel putin un actor cu varsta mai mica decat 50");
        for (int i = 0; i < studioDataBase.length; i++) {
            for (int j = 0; j < studioDataBase[i].getFilme().length; j++) {
                for (int k = 0; k < studioDataBase[i].getFilme()[j].getActori().length; k++) {
